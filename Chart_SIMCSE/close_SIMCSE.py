...
# predict the next 6 hours given the past 24 hours 
...
for epoch_i in tqdm(range(epochs), desc="Epochs", position=0, leave=True, total=epochs):
    ...
    if avg_val_loss < best_val_loss: 
        ...
        torch.save(model.state_dict(), "24_BTC_SIMCSE.pt") 
        
os.rename("24_BTC_SIMCSE.pt", f"24_BTC_SIMCSE_val_loss_{best_val_loss}.pt") 
